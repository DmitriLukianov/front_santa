...
import { fetchMyWishlist, fetchWishlistItems, deleteWishlistItem, updateWishlistItem, isAuthenticated, uploadFile, fetchGameById } from '/src/api/gameApi.jsx';
...
function WishlistRed() {
  ...
  useEffect(() => {
    ...
    const loadItem = async () => {
      ...
      try {
        ...
        // 1. Получаем вишлист (с eventId или без) и бюджет игры
  ...
  return (
    <div className="overlay_wishlist">
      <div className="card_wishlist" style={{ position: 'relative' }}>
        ...
        <button
          ...
          style={{
            ...
            color: '#e74c3c', opacity: isSaving ? 0.4 : 1,
            transition: 'background 0.15s',
          }}
          onMouseEnter={e => e.currentTarget.style.background = '#fde8e8'}
          onMouseLeave={e => e.currentTarget.style.background = 'none'}
        >
          <i className="ti ti-trash" style={{ fontSize: '22px' }}></i>
        </button>
